...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\1tapgang\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\1tapgang", NULL);
	...
	{
		CreateDirectory("C:\\1tapgang\\", NULL); CreateDirectory("C:\\1tapgang\\", NULL);
		std::ofstream ofs("C:\\1tapgang\\" + name + ".cfg");
	}
